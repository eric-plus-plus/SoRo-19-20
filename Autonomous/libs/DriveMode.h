...
public:
    ...
    DriveMode(std::string mainFile, std::string leftFile, std::string rightFile, double speed); //the video file of the camera and the base speed that the rover drives at
