...
class ARTracker
{
    public:
        ...
        int findAR(int id); //false if nothing found, true else. Updates angleToAR and distanceToAR
        int findARs(int id1, int id2); //same as above except looking for the gate instead of a single post
