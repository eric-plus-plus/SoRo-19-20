...
Added a cmake to this directory and can be linked with the library gps in another directory's cmake. However, the variables in gps.h had to be externed for this to work.
